...
ROLLOUT_FLOW_TOKEN_CE_WEIGHT = 0.02
...
ROLLOUT_COSINE_LOSS_WEIGHT = 0.2
ROLLOUT_DIVERSITY_MAX_TOKENS = 512
ROLLOUT_BATCH = 64
ROLLOUT_TRAIN_STEPS = 8
LATENT_PROJECTOR = True
LATENT_PROJECTOR_ONLY = True
LATENT_PROJECTOR_HIDDEN_DIM = 512
LATENT_PROJECTOR_DEPTH = 3
LATENT_PROJECTOR_RES_SCALE = 0.10
LATENT_PROJECTOR_LR = 1e-4
LATENT_PROJECTOR_MSE_WEIGHT = 1.0
LATENT_PROJECTOR_COSINE_WEIGHT = 0.2
LATENT_PROJECTOR_TOKEN_CE_WEIGHT = 0.05
...
DECODER_ADAPT_GEN_CE_WEIGHT = 0.01
